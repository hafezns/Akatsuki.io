                ...
                <section class="text-gray-600 body-font overflow-hidden">
                    <div class="container px-3 py-20 mx-auto">
                        <div class="max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
                            <img
                                src="https://drive.google.com/uc?export=view&id=1EI8xDuxoMfcvQsXGiOrAP1njjwlubII3"
                                alt=""
                            ...
                            <div class="flex items-center px-6 py-3 bg-gray-900">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" className="bg-white rounded h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0m-5 8a2 2 0 100-4 2 2 0 000 4zm0 0c1.306 0 2.417.835 2.83 2M9 14a3.001 3.001 0 00-2.83 2M15 11h3m-3 4h2" />
                                </svg>

                                <h1 class="mx-3 text-lg font-semibold text-white">Admin Akatsuki.io</h1>
                            </div>

                            <div class="px-6 py-4">
                                <h1 class="text-xl font-semibold text-gray-800 dark:text-white">Hafez Nizamuddin Salim</h1>

                                <p class="py-2 text-gray-700 dark:text-gray-400">Admin.</p>
                                ...
                                <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                                    ...
                                    <h1 class="px-2 text-sm">Akatsuki.io</h1>
                                </div>
                                ...
                                <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                                    ...
                                    <h1 class="px-2 text-sm">Purbalingga, Central Java</h1>
                                </div>
                                ...
                                <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                                    ...
                                    <h1 class="px-2 text-sm">hafezns123@gmail.com</h1>
                                </div>
                            </div>
                        </div>
